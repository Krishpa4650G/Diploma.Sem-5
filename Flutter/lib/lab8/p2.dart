...
class p2 extends StatefulWidget
{
  const p2({super.key});
  @override
  State<p2> createState() => _SurveyFormState();
}
class _SurveyFormState extends State<p2>
...
centerTitle: true,
title: const Text('Survey Form', style: TextStyle(color: Colors.white),)
),
body: Padding(
...
RadioListTile(
title: const Text('36-50'), value: '36-50',
groupValue: _ageGroup,
onChanged: (value) {
  setState(() {
    _ageGroup = value.toString();
